...
const Register = () => {
  ...
  const { mobile, setemail, email, setlastName, lastName, setfirstName } =
  ...
  const handleOTP = () => {
    if (verified) alert("Already verified");
    else {
  ...
  return (
    <div style={{ height: "700px" }}>
      ...
      >
        ...
        {first ? (
          <Button colorScheme="red" variant="outline" onClick={handleEmail}>
            Verify Email
          </Button>
        ) : (
          <Flex>
