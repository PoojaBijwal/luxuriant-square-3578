                ...
                <ModalContent>
                  ...
                  <ModalBody>
                    <Flex flexDirection="column" gap="1rem">
                      <Input
                        placeholder="Pincode*"
                        ref={(e) => (address.current["pin"] = e)}
                      />
                      <Flex gap="1rem">
                        <Input
                          placeholder="Enter First Name*"
                          ref={(e) => (address.current["first"] = e)}
                          value={firstName}
                        />
                        <Input
                          placeholder="Enter Last Name*"
                          ref={(e) => (address.current["last"] = e)}
                          value={lastName}
                        />
                      </Flex>
                      <Input
                        placeholder="Enter Flat / Building Name*"
                        ref={(e) => (address.current["flat"] = e)}
                      />
                      <Input
                        placeholder="Enter  Colony / Street*"
                        ref={(e) => (address.current["street"] = e)}
                      />
                      <Input
                        placeholder="Enter Landmark"
                        ref={(e) => (address.current["landmark"] = e)}
                      />
                      <Flex gap="1rem">
                        <Input
                          placeholder="Enter City*"
                          ref={(e) => (address.current["city"] = e)}
                        />
                        <Input
                          placeholder="Enter State*"
                          ref={(e) => (address.current["state"] = e)}
                        />
                      </Flex>
                      <Flex gap="1rem">
                        <Input
                          placeholder="Enter mobile number*"
                          ref={(e) => (address.current["mobile"] = e)}
                          value={mobile}
                        />
                        <Input
                          placeholder="Enter landline number*"
                          ref={(e) => (address.current["land"] = e)}
                        />
                      </Flex>
                    </Flex>
                  </ModalBody>
                      ...
                      onClick={() => {
                        ...
                        if (
                          ...
                          toast({
                            ...
                            description:
                              "We'll use this for further communication.",
                            status: "success",
                            duration: 9000,
                            isClosable: true,
                          });
