...
const Navbar = () => {
  ...
  return (
    <div>
      ...
      <Box bg={"#ff1616"} color="white">
        <br />
        <Flex>
          <Spacer />
          <Box width="150px" marginBottom ="10px">
          <Image src={logo} alt="logo" w={{base:"120px",lg:"400px"}} h="60px"  />
        ...
        >
          <div className="box98" style={{ cursor: "pointer" }}>
            MOBILES & TABLETS
          </div>
          <div className="box99">
            <div
            ...
            >
              ...
              >
                ...
                <p onClick={() => navigate("/smartwatches")}>
                  Wearable Technology
                </p>
          ...
          <div className="box97" style={{ cursor: "pointer" }}>
            TELEVISIONS
          </div>
          <div className="box99">
            <div
          ...
          <div className="box96" style={{ cursor: "pointer" }}>
            HEADPHONES & SPEAKERS
          </div>
          <div className="box99">
            <div
          ...
          <div className="box95" style={{ cursor: "pointer" }}>
            HOME APPLIANCES
          </div>
          <div className="box99">
            <div
          ...
          <div className="box94" style={{ cursor: "pointer" }}>
            COMPUTERS
          </div>
          <div className="box99">
            <div
